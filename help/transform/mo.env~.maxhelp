...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 72.341291197926921, 167.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "3",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
					"textoncolor" : [ 1.0, 1.0, 1.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 92.0, 253.0, 50.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Adjust the global sensitivity.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 83.0, 324.0, 23.0 ],
					"text" : "Follow the amplitude of multichannel audio signals."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 41.0, 209.0, 201.0, 23.0 ],
					"text" : "mc.rand~ @chans 2 @initialvalues 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 150.0, 254.5, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
					"textoncolor" : [ 1.0, 1.0, 1.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 176.0, 291.0, 50.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 176.0, 334.047930985689163, 79.0, 23.0 ],
					"text" : "sensitivity $1"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 41.0, 389.0, 70.0, 62.0 ],
					"varname" : "mo.env~",
					"viewvisibility" : 1
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 1 ],
					"midpoints" : [ 101.5, 279.0, 101.5, 279.0 ],
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 1 ],
					"midpoints" : [ 185.5, 375.0, 101.5, 375.0 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 185.5, 315.0, 185.5, 315.0 ],
					"source" : [ "obj-7", 0 ]
				}
		...
		"originid" : "pat-1732",
		"parameters" : 		{
			"obj-2::obj-12" : [ "live.text[429]", "live.text", 0 ],
			"obj-2::obj-13" : [ "live.numbox[160]", "live.numbox", 0 ],
			"obj-2::obj-28" : [ "live.numbox[161]", "live.numbox", 0 ],
			"obj-2::obj-34" : [ "live.numbox[159]", "live.numbox", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
