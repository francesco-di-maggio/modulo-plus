...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 283.5, 23.0, 57.0, 21.0 ],
									"text" : "end time"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 198.0, 23.0, 64.0, 21.0 ],
									"text" : "start time"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 255.0, 215.987990999999994, 155.0, 21.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 255.0, 177.240982000000002, 154.0, 35.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 255.0, 119.246994000000001, 106.0, 35.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 82.0, 158.0, 74.0, 21.0 ],
									"text" : "groove sync"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 29.0, 383.0, 62.0, 21.0 ],
									"text" : "audio out"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 20.5, 158.0, 52.0, 21.0 ],
									"text" : "audio in"
								}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 92.859152223914862, 4.0, 116.801539216190548, 15.0 ],
					"rounded" : 0.0,
					"saved_attribute_attributes" : 					{
						"textcolor" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 35.0, 204.0, 68.0 ],
					"saved_attribute_attributes" : 					{
						"slidercolor" : 						{
							"expression" : "themecolor.live_control_fg"
						}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.209559142589569, 27.90647479891777, 203.0, 47.0 ],
					"saved_attribute_attributes" : 					{
						"gridcolor" : 						{
							"expression" : "themecolor.live_control_fg"
						}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.320670247077942, 79.318458536241451, 203.0, 21.0 ],
					"ruler" : 0,
					"saved_attribute_attributes" : 					{
						"gridcolor" : 						{
							"expression" : "themecolor.live_control_fg"
