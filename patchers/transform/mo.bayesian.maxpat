...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 52.538028299808502, 43.0, 47.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1150.0, 453.0, 58.0, 17.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 4.0, 43.0, 47.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : ""
						}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 223.0, 674.0, 206.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1100.0, 270.0, 58.0, 23.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1100.0, 295.0, 82.0, 23.0 ],
					"text" : "a-mo.settings"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1157.0, 345.0, 70.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1100.0, 320.0, 127.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 37.0, 723.0, 81.0, 23.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 37.0, 684.0, 29.5, 23.0 ],
					"text" : "!- 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 37.0, 653.0, 62.799999999999955, 15.313138370215711 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 37.0, 767.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 856.5, 453.5, 103.0, 16.0 ],
					"presentation" : 1,
		...
		"lines" : [ 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 1 ],
					"midpoints" : [ 108.0, 633.0, 108.5, 633.0 ],
					"order" : 1,
					"source" : [ "obj-109", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1159.5, 471.0, 1159.0, 471.0 ],
					"source" : [ "obj-135", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1109.5, 294.0, 1109.5, 294.0 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1109.5, 321.0, 1109.5, 321.0 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 46.5, 747.0, 46.5, 747.0 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 46.5, 708.0, 46.5, 708.0 ],
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 46.5, 669.0, 46.5, 669.0 ],
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
		...
		"originid" : "pat-658",
		"parameters" : 		{
			"obj-135" : [ "live.text[929]", "live.text", 0 ],
			"obj-155" : [ "live.numbox[50]", "live.dial[12]", 0 ],
			"obj-31" : [ "live.numbox[333]", "live.numbox", 0 ],
			"obj-7" : [ "live.text[948]", "live.text", 0 ],
			"obj-70" : [ "live.numbox[358]", "live.numbox", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
