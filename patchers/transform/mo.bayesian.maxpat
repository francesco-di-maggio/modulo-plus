...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 344.5, 494.125, 44.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 6.5, 49.0, 55.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1088.5, 458.0, 44.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 138.75275424658355, 49.0, 37.231164742726151, 15.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 793.5, 453.5, 90.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 7.651201665401459, 66.02060928445627, 167.986652026068441, 15.0 ],
					"rounded" : 0.0,
					"text" : "1.",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 93.5, 494.125, 44.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 6.5, 33.371792723306498, 55.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 454.5, 28.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 785.0, 217.999999999999972, 210.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 785.0, 182.141889015359482, 266.0, 23.0 ],
					"saved_object_attributes" : 					{
						"initial" : [ -2 ],
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 785.0, 146.283778030718992, 249.0, 22.0 ],
					"saved_object_attributes" : 					{
						"initial" : [ -100 ],
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 785.0, 110.425667046078502, 230.0, 23.0 ],
					"saved_object_attributes" : 					{
						"initial" : [ 1 ],
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 534.0, 173.141889015359482, 38.0, 23.0 ],
					"text" : "zl.reg"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 6,
					"outlettype" : [ "", "", "", "", "", "" ],
					"patching_rect" : [ 397.551895529031754, 110.425667046078502, 246.0, 23.0 ],
					"text" : "route chans jumprate diffusion mvc calibrate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 344.5, 28.0, 58.0, 23.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 344.551895529031754, 56.02060928445627, 73.0, 23.0 ],
					"text" : "patcherargs"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 852.5, 546.0, 26.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 179.0, 64.52060928445627, 26.0, 18.0 ],
					"text" : "mcv"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 575.5, 489.25, 50.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 93.5, 310.999999999999886, 60.0, 23.0 ],
					"text" : "zl.change"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 93.5, 276.626276284456253, 37.0, 23.0 ],
					"text" : "zl.len"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1152.5, 546.0, 70.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 134.368336617946625, 31.910254408487162, 46.0, 18.0 ],
					"text" : "calibrate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 793.5, 485.5, 62.0, 23.0 ],
					"text" : "route text"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 861.5, 485.5, 162.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 793.5, 525.0, 137.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 629.5, 485.5, 147.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 575.5, 525.0, 81.0, 23.0 ],
					"text" : "prepend dims"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 441.5, 546.0, 65.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 60.599099099636078, 47.5, 65.0, 18.0 ],
					"text" : "diffusion rate"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 186.5, 546.0, 66.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 60.599099099636078, 31.871792723306498, 66.0, 18.0 ],
					"text" : "sudden jumps"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 344.5, 525.0, 179.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 93.5, 525.0, 180.0, 23.0 ],
...
,
					"patching_rect" : [ 1060.5, 545.0, 75.0, 23.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1134.5, 494.125, 206.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 37.5, 751.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 37.82135084271431, 28.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 149.5, 485.5, 179.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 398.5, 485.5, 142.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "float", "" ],
					"patching_rect" : [ 37.5, 608.162493303418159, 639.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 93.5, 363.051943330534755, 44.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 171.071533560752869, 7.0, 36.928466439247131, 15.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 91.75, 19.842577278614044, 55.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 4.0, 55.0, 21.0 ],
					"text" : "bayesian",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 103.0, 594.0, 47.0, 594.0 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 47.0, 642.0, 1047.0, 642.0, 1047.0, 540.0, 1126.0, 540.0 ],
					"order" : 0,
					"source" : [ "obj-109", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-109", 0 ],
					"midpoints" : [ 585.0, 594.0, 47.0, 594.0 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1098.0, 531.0, 1098.0, 531.0 ],
					"source" : [ "obj-135", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-109", 0 ],
					"midpoints" : [ 354.0, 594.0, 47.0, 594.0 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 103.0, 516.0, 103.0, 516.0 ],
					"source" : [ "obj-155", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 464.0, 96.0, 407.051895529031754, 96.0 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-109", 0 ],
					"midpoints" : [ 47.32135084271431, 60.0, 47.0, 60.0 ],
					"order" : 1,
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 47.32135084271431, 261.0, 103.0, 261.0 ],
					"order" : 0,
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 103.0, 333.0, 103.0, 333.0 ],
					"source" : [ "obj-27", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 803.0, 510.0, 803.0, 510.0 ],
					"source" : [ "obj-28", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-27", 0 ],
					"midpoints" : [ 103.0, 300.0, 103.0, 300.0 ],
					"source" : [ "obj-34", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 543.5, 435.0, 803.0, 435.0 ],
					"source" : [ "obj-35", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-11", 0 ],
					"midpoints" : [ 585.0, 513.0, 585.0, 513.0 ],
					"source" : [ "obj-36", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 588.651895529031776, 435.0, 1098.0, 435.0 ],
					"source" : [ "obj-40", 4 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 452.451895529031731, 471.0, 103.0, 471.0 ],
					"source" : [ "obj-40", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 497.851895529031765, 471.0, 354.0, 471.0 ],
					"source" : [ "obj-40", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 543.251895529031799, 159.0, 562.5, 159.0 ],
					"order" : 0,
					"source" : [ "obj-40", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 543.251895529031799, 135.0, 543.5, 135.0 ],
					"order" : 1,
					"source" : [ "obj-40", 3 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-70", 0 ],
					"midpoints" : [ 407.051895529031754, 357.0, 103.0, 357.0 ],
					"source" : [ "obj-40", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 354.0, 51.0, 354.051895529031754, 51.0 ],
					"source" : [ "obj-44", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-40", 0 ],
					"midpoints" : [ 408.051895529031754, 81.0, 407.051895529031754, 81.0 ],
					"source" : [ "obj-46", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-70", 0 ],
					"midpoints" : [ 354.051895529031754, 357.0, 103.0, 357.0 ],
					"source" : [ "obj-46", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-109", 0 ],
					"midpoints" : [ 1070.0, 594.0, 47.0, 594.0 ],
					"source" : [ "obj-69", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-137", 0 ],
					"midpoints" : [ 1126.0, 579.0, 1035.0, 579.0, 1035.0, 435.0, 803.0, 435.0 ],
					"source" : [ "obj-69", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-109", 0 ],
					"midpoints" : [ 803.0, 594.0, 47.0, 594.0 ],
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 103.0, 405.0, 165.0, 405.0, 165.0, 306.0, 144.0, 306.0 ],
					"order" : 2,
					"source" : [ "obj-70", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 103.0, 471.0, 585.0, 471.0 ],
					"order" : 1,
					"source" : [ "obj-70", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 103.0, 435.0, 1070.0, 435.0 ],
					"order" : 0,
					"source" : [ "obj-70", 0 ]
				}
		...
		"parameters" : 		{
			...
			"obj-31" : [ "live.numbox[6]", "live.dial[12]", 0 ],
